class Slider {
    ...
    initializeSlider() {
        ...
        this.addSlideAtributes(0);

        this.slideArrayLength = this.images.length;
    ...
    addSlideAtributes(index) {
        this.image.setAttribute('src', Array.isArray(this.images) && this.images.length > 0 && this.images[index]);
